...
walk:
	// n 将会是一个不断迭代的变量，总是指向下一个进行搜索的 node
	// 一开始 n 总是指向某一个 HTTP Method 的 route tree 的 Root 节点
	// 后面则是在 continue walk 之前，替换为下一个进行检查的 node
	for {
